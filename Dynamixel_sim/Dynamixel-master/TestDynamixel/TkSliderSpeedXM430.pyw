...
mod_spec = ["implementation_id", "TkSliderSpeedXM430", 
            "type_name", "TkSliderSpeedXM430", 
            "description", "", 
            "version", "1.0", 
            "vendor", "MasutaniLab", 
            "category", "Generic", 
...
class TkSliderSpeedXM430(OpenRTM_aist.DataFlowComponentBase):
...
def TkSliderSpeedXM430Init(manager):
...
def MyModuleInit(manager):
  TkSliderSpeedXM430Init(manager)

  # Create a component
  comp = manager.createComponent("TkSliderSpeedXM430")
