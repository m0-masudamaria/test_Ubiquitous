...
mod_spec = ["implementation_id", "TkMonitorSliderPosition", 
            "type_name", "TkMonitorSliderPosition", 
            "description", "", 
            "version", "1.0", 
            "vendor", "MasutaniLab", 
            "category", "Generic", 
...
class TkMonitorSliderPosition(OpenRTM_aist.DataFlowComponentBase):
...
def TkMonitorSliderPositionInit(manager):
  profile = OpenRTM_aist.Properties(defaults_str=mod_spec)
  manager.registerFactory(profile,
                          TkMonitorSliderPosition,
                          OpenRTM_aist.Delete)

def MyModuleInit(manager):
  TkMonitorSliderPositionInit(manager)

  # Create a component
  comp = manager.createComponent("TkMonitorSliderPosition")
