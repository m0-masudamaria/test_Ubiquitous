...
mod_spec = ["implementation_id", "TkSliderCommand", 
            "type_name", "TkSliderCommand", 
            "description", "", 
            "version", "1.0", 
            "vendor", "MasutaniLab", 
            "category", "Generic", 
...
class TkSliderCommand(OpenRTM_aist.DataFlowComponentBase):
...
def TkSliderCommandInit(manager):
...
def MyModuleInit(manager):
  TkSliderCommandInit(manager)

  # Create a component
  comp = manager.createComponent("TkSliderCommand")
