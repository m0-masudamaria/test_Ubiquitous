...
channels = (
  ("C1", 0, 4095, 1, 200, 2048),
  ("C2", 0, 4095, 1, 200, 3200),
  ("C3", 0, 4095, 1, 200, 110),
  ("C4", 0, 4095, 1, 200, 1750),
  ("C5", 0, 4095, 1, 200, 2048))

mod_spec = ["implementation_id", "TkSliderCommandXM430", 
            "type_name", "TkSliderCommandXM430", 
            "description", "", 
            "version", "1.0", 
            "vendor", "MasutaniLab", 
            "category", "Generic", 
...
class TkSliderCommandXM430(OpenRTM_aist.DataFlowComponentBase):
...
def TkSliderCommandXM430Init(manager):
  profile = OpenRTM_aist.Properties(defaults_str=mod_spec)
  manager.registerFactory(profile,
                          TkSliderCommandXM430,
                          OpenRTM_aist.Delete)

def MyModuleInit(manager):
  TkSliderCommandXM430Init(manager)

  # Create a component
  comp = manager.createComponent("TkSliderCommandXM430")
