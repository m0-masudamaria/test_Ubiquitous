...
mod_spec = ["implementation_id", "TkSliderGain", 
            "type_name", "TkSliderGain", 
            "description", "", 
            "version", "1.0", 
            "vendor", "MasutaniLab", 
            "category", "Generic", 
...
class TkSliderGain(OpenRTM_aist.DataFlowComponentBase):
...
def MyModuleInit(manager):
  TkSliderGainInit(manager)

  # Create a component
  comp = manager.createComponent("TkSliderGain")
