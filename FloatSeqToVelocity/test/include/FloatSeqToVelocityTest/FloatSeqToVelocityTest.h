  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   * @brief destructor
   */
  ~FloatSeqToVelocityTest() override;
 ...
 protected:
  ...
  /*!
   * 
   * - Name:  rotation_by_position
   * - DefaultValue: -0.02
   */
  double m_rotation_by_position;
  /*!
   * 
   * - Name:  velocity_by_position
   * - DefaultValue: 0.002
   */
  ...
  /*!
   */
  RTC::InPort<RTC::TimedVelocity2D> m_outIn;
  ...
  /*!
   */
  RTC::OutPort<RTC::TimedFloatSeq> m_inOut;
